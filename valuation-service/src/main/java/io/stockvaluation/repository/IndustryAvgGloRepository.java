...
@Repository
public interface IndustryAvgGloRepository extends JpaRepository<IndustryAveragesGlobal, Long> {

    @Query("SELECT ing.salesToCapital FROM IndustryAveragesUS ing WHERE ing.industryName =:industryName  ")
