...
class ValuationWorkflowServiceImplTest {
    ...
    void getValuation_postWithSegments_callsSegmentWeightingAndReturnsFcffOutput() {
        ...
        verify(commonService, times(2)).applySegmentWeightedParameters(any(FinancialDataInput.class), eq(companyData), anyList());
    ...
    private void stubHappyPath(
        ...
        when(valuationOutputService.calculateFinancialData(any(FinancialDataInput.class), any(RDResult.class), any(), anyString(), isNull()))
