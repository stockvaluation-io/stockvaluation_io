...
public class Helper {
    ...
    public static double calculateGrowthRate(double totalRevenueTTM, double revenueLTM) {
        if (revenueLTM == 0) {
            throw new IllegalArgumentException("revenueLTM cannot be zero.");
        }
    ...
    public static double adjustTargetPreTaxOperatingMargin(double operatingMarginNextYear) {
        return Math.min(operatingMarginNextYear, 0.40);
    }
